...
local settings = {
			structure = {val = "struct", type = "table"}, -- Base structure of a docstring, represented as a table with 2 or more elements
		  	...
		  	is_param_data_one_line = {val = "is_param_data_one_line", type = "boolean"}, -- Determines if the param name and type go on the same line or not
...
local templates = {
		python = {
			Google = {
				...
				[settings.is_param_data_one_line.val] = true,
