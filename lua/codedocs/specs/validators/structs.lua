...
local function validate_struct_style(struct_path, struct_styles, struct_name, lang)
...
local function validate_struct_dirs(structs, struct_styles, lang)
